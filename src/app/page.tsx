  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <section className="relative min-h-[100svh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] sm:w-[800px] h-[500px] sm:h-[800px] bg-[#D4AF37]/5 rounded-full blur-[100px] sm:blur-[150px]" />
