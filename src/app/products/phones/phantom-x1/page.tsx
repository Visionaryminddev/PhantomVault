...
export const metadata: Metadata = {
  title: 'Phantom X1 | PhantomPrivacy',
  description: 'Premium privacy smartphone met Titan M2 chip, hardware kill switches en PhantomOS.',
};
...
const product = {
  ...
  price: '€899',
  originalPrice: '€999',
  description: 'De perfecte balans tussen geavanceerde beveiliging en dagelijks gebruiksgemak. De Phantom X1 biedt enterprise-grade privacy features in een stijlvol, gebruiksvriendelijk pakket.',
  highlights: [
    'Titan M2 Security Chip voor hardware-level beveiliging',
    'Hardware Kill Switches voor camera en microfoon',
    'PhantomOS 4.0 - Google-vrij besturingssysteem',
    '6.5" AMOLED display met 90Hz refresh rate',
    'Snapdragon 8 Gen 2 processor',
    '4 jaar gegarandeerde security updates',
  ],
};

const specs = {
  display: [
    { name: 'Schermgrootte', value: '6.5 inch' },
    { name: 'Type', value: 'AMOLED' },
    { name: 'Resolutie', value: '2400 x 1080 pixels (FHD+)' },
    { name: 'Refresh Rate', value: '90Hz' },
    { name: 'Helderheid', value: '1800 nits peak' },
    { name: 'Bescherming', value: 'Gorilla Glass Victus' },
  ],
  performance: [
    { name: 'Processor', value: 'Qualcomm Snapdragon 8 Gen 2' },
    { name: 'CPU', value: '1x3.2GHz + 2x2.8GHz + 2x2.5GHz + 3x1.8GHz' },
    { name: 'GPU', value: 'Adreno 740' },
    { name: 'RAM', value: '8GB LPDDR5X' },
    { name: 'Opslag', value: '128GB / 256GB UFS 4.0' },
  ],
  camera: [
    { name: 'Hoofdcamera', value: '50MP, f/1.8, OIS' },
    { name: 'Ultrawide', value: '12MP, f/2.2, 120° FOV' },
    { name: 'Frontcamera', value: '12MP, f/2.2' },
    { name: 'Video', value: '4K@60fps, 1080p@120fps' },
  ],
  security: [
    { name: 'Security Chip', value: 'Titan M2 (FIPS 140-2 Level 3)' },
    ...
    { name: 'Biometrie', value: 'In-display optical fingerprint' },
  ],
  battery: [
    { name: 'Capaciteit', value: '4700mAh' },
    { name: 'Snelladen', value: '45W wired, 15W wireless' },
  ...
  physical: [
    { name: 'Afmetingen', value: '158.2 x 73.8 x 8.2 mm' },
    { name: 'Gewicht', value: '189g' },
    { name: 'Water/stof', value: 'IP68' },
    { name: 'Materiaal', value: 'Aluminium frame, Glas achterkant' },
  ],
};
...
const features = [
  {
    ...
    description: 'Dedicated security processor die je cryptografische sleutels, wachtwoorden en biometrische data beschermt in een geïsoleerde omgeving.',
  },
  {
    icon: '🔇',
    title: 'Privacy Kill Switches',
    description: 'Fysieke schakelaars aan de zijkant van het toestel om direct camera en microfoon uit te schakelen op hardware niveau.',
  },
  {
    icon: '🛡️',
    title: 'PhantomOS 4.0',
    description: 'Ons beveiligde Android-besturingssysteem zonder Google tracking. Volledige controle over permissions en network access.',
  },
  {
    icon: '📊',
    title: 'Privacy Dashboard',
    description: 'Uitgebreid overzicht van alle app permissions, data gebruik en network activiteit. Altijd inzicht in wie toegang heeft tot wat.',
  },
];

const inBox = [
  'Phantom X1',
  'USB-C naar USB-C kabel (1.2m)',
  '45W USB-C oplader',
  'SIM eject tool',
  'Quick Start Guide',
];

export default function PhantomX1Page() {
  return (
    <main className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <nav className="flex items-center text-sm text-gray-500">
          ...
          <span className="mx-2">/</span>
          <span className="text-gray-300">Phantom X1</span>
        </nav>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div className="flex items-baseline gap-4 mb-6">
              ...
              <Badge variant="gold">Bespaar €100</Badge>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex gap-4">
                <button className="w-12 h-12 bg-black border-2 border-[#D4AF37] rounded-full" title="Midnight Black" />
                <button className="w-12 h-12 bg-gray-700 border-2 border-transparent rounded-full hover:border-[#D4AF37] transition-colors" title="Graphite" />
              </div>
            </div>
      ...
      <Section className="bg-[#111111]/30">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            Premium <span className="text-gradient-gold">Security Features</span>
          </h2>
        </div>
      ...
      <Section>
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Niet zeker welke past bij jou?</p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Button variant="outline" href="/products/phones/phantom-lite">
            Bekijk Lite
          </Button>
          <Button variant="outline" href="/products/phones">
            Alle Telefoons
          </Button>
        </div>
      </Section>
      ...
      <Section className="bg-[#111111]/30">
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-400 mb-8">
            Bestel vandaag en ontvang je Phantom X1 binnen 2-3 werkdagen.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button size="lg">
